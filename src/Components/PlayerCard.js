    ...
    return (
        <div key={stateProps.player.id} className={displayPlayer()} id={`joueur${stateProps.player.id}`}>
            <div className="card-body text-center ">
                ...
                <div className="row ">
                    <div >
                        {/* <ButtonAttack player={stateProps.player} played= {displayButton()} countPlayer = {stateProps.countPlayer} playerList = {stateProps.playerList}/> */}
                        <ButtonAttack player={stateProps.player} played= {displayButton()} countPlayer = {stateProps.countPlayer} playerList = {stateProps.playerList}/>
                        <ButtonMana player={stateProps.player} played= {displayButton()} countPlayer = {stateProps.countPlayer} playerList = {stateProps.playerList}/>
                        <ButtonHeal player={stateProps.player} played= {displayButton()} countPlayer = {stateProps.countPlayer} playerList = {stateProps.playerList}/>
                    </div>
                </div >
            </div >
        </div >
