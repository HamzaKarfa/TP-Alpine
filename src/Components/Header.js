...
const HeaderConnect=( ) => {
    ...
    <header className="col header" >
        ...
        <div className="col text-center headerDiv my-5" >
            ...
            <a className="btn btn-lg btn-outline-primary animate__animated animate__delay-1s animate__heartBeat animate__infinite" href="/Version" >Commencer votre configuration</a >
        </div >
    </header >
);
