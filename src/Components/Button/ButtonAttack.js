...
const ButtonCapacityConnect =({hitMonsters,hitBack,stateProps,addPlayerTurns,playerDeads})=> {
        ...
        const activate = ()=> {
            ...
            if (stateProps.played || stateProps.player.mana < 5) {
                return 'btn btn-success material-tooltip-main attack disabled'
            }else{
...
const ButtonAttack = connect(stateButtonCapacity,dispatchButtonCapacity)(ButtonCapacityConnect)
